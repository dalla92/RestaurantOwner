...
public class DataInitialization {
    ...
    public void offer_fake_initialization() {
        of = new Offer();
        of.setIs_offer_at_dinner(true);
        of.setIs_offer_at_lunch(false);
        ...
        of2 = new Offer();
        of2.setIs_offer_at_dinner(true);
        of2.setIs_offer_at_lunch(false);
    ...
    public void restaurant_fake_initialization() {
        ...
        res.setIs_credit_card_accepted(true);
        res.setIs_fidelity_program_accepted(true);
        res.setIs_table_reservation_allowed(true);
        res.setIs_take_away_allowed(true);
        res.setIs_tv_present(false);
        res.setIs_wifi_present(true);
        ...
        */
        ...
        res2.setIs_air_conditioned_present(false);
        res2.setIs_animal_allowed(false);
        res2.setIs_celiac_friendly(false);
        res2.setIs_credit_card_accepted(false);
        res2.setIs_fidelity_program_accepted(false);
        res2.setIs_table_reservation_allowed(false);
        res2.setIs_take_away_allowed(false);
        res2.setIs_tv_present(false);
        res2.setIs_wifi_present(false);
